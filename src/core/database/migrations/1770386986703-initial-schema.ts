...
export class InitialSchema1770386986703 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "artwork" ("id" SERIAL NOT NULL, "type" "public"."artwork_type_enum" NOT NULL, "title" character varying NOT NULL, "description" text, "year" integer, "country" character varying, "technique" "public"."artwork_technique_enum", "genre" "public"."artwork_genre_enum", "physical_height" numeric(10,2), "physical_width" numeric(10,2), "physical_depth" numeric(10,2), "digital_height" integer, "digital_width" integer, "file_size" bigint, "materials" text, "tools" text, "tags" text array, "visibility" "public"."artwork_visibility_enum" NOT NULL DEFAULT 'PUBLIC', "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "collection_id" integer, "user_id" integer NOT NULL, CONSTRAINT "PK_ee2e7c5ad7226179d4113a96fa8" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "user" ("id" SERIAL NOT NULL, "name" character varying(100) NOT NULL, "username" character varying(50) NOT NULL, "email" character varying(255) NOT NULL, "passwordHash" character varying(255), "bio" character varying(255), "avatarUrl" character varying(500), "googleId" character varying(255), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, CONSTRAINT "UQ_78a916df40e02a9deb1c4b75edb" UNIQUE ("username"), CONSTRAINT "UQ_e12875dfb3b1d92d7d7c5377e22" UNIQUE ("email"), CONSTRAINT "UQ_470355432cc67b2c470c30bef7c" UNIQUE ("googleId"), CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "refresh_tokens" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "user_id" integer NOT NULL, "token" character varying(500) NOT NULL, "expires_at" TIMESTAMP NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_4542dd2f38a61354a040ba9fd57" UNIQUE ("token"), CONSTRAINT "PK_7d8bee0204106019488c4c50ffa" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
